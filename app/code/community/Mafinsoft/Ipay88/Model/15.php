 ...
 */
class Mafinsoft_Ipay88_Model_15 extends Mafinsoft_Ipay88_Model_Shared
{  
	/**   
	* payment id assigned by iPay88   
	*	
	* Hong Leong Bank Transfer - MYR only
	**/
	protected $_code			= 'ipay88_15';
	protected $_paymentMethod	= '15';
