 ...
 */
class Mafinsoft_Ipay88_Model_8 extends Mafinsoft_Ipay88_Model_Shared
{  
	/**   
	* payment id assigned by iPay88   
	*	
	* Alliance Online Transfer - MYR only
	**/
	protected $_code			= 'ipay88_8';
	protected $_paymentMethod	= '8';
