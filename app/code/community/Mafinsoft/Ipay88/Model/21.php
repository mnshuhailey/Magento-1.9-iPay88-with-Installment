 ...
 */
class Mafinsoft_Ipay88_Model_21 extends Mafinsoft_Ipay88_Model_Shared
{  
	/**   
	* payment id assigned by iPay88   
	*	
	* China Union Pay - CNY only
	**/
	protected $_code			= 'ipay88_21';
	protected $_paymentMethod	= '21';
	protected $_paymentMethodCurrency = 'CNY';	
}
?>