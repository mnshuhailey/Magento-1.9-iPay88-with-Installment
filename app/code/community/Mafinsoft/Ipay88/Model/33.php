 ...
 */
class Mafinsoft_Ipay88_Model_33 extends Mafinsoft_Ipay88_Model_Shared
{  
	/**   
	* payment id assigned by iPay88   
	*
	* PayPal - powered by iPay88 - USD only
	**/
	protected $_code			= 'ipay88_33';
	protected $_paymentMethod	= '33';
